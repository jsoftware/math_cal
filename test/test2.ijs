...
0 :0
Friday 23 August 2019  16:55:16
-
Test the mixed-case instructions and those that poll the result:
 Repe Redo Undo Revt DIRT MSSG MSID
also the uuengine pass-thru instructions.
)
cocurrent 'cal'
Q=: 3 : 'q1234__=: y'
...
Q tt'CTBU'
A zcc
Q tt'DIRT'  NB. before any material alteration of t-table
A 0
Q tt'newu kW h'
A i.0 0
Q tt'DIRT'
A 1
Q tt'newu *'  NB. as in: newsl_tabby_
A i.0 0


smoutput '+++ COMPLETED: testing of Mixed-case instructions'

NB. ---------------------------------------------------------
0 :0
COPY OF CAL FROM CAL_interface.ijs
Saturday 25 May 2019  18:08:39
>>> INDENT EACH ROW ONCE IT HAS BEEN USED ABOVE
