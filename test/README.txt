README.txt
----
Saturday 24 August 2019  05:43:58

See bottom of this file for CAL_interface,
 and which instrs have good tests.

----
Friday 23 August 2019  12:26:21

test0.ijs
  unfinished but serviceable
  needs generalizing to all variants of LOADFORMAT, SAVEFORMAT

TEST.jproj
  is simply a workflow list, to open selected in-progress files
  …normally use tab: [files]

build.ijs
  dummy placeholder file
  simply announces itself

run.ijs
  uses [HANDY] loadall to run: test*.ijs in sys-defined order
  …which we hope will be numerical order.

----
Saturday 11 May 2019  08:34:25

This is README for CAL test suite.

Files: test*.ijs
  are stubs with correctly formatted headers
Files: *.ijsX
  inoperative but contain test code to port into test*.ijs

-----------------------------------------

COPY OF CAL FROM CAL_interface.ijs
Saturday 25 May 2019  18:08:39
>>> INDENT EACH INST ONCE IT HAS BEEN TESTED
